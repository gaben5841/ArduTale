#include <Arduboy2.h>
#include <ArduboyPlaytune.h> //was going to try to play music
Arduboy2 arduboy;
//variables declared
int gamestate = 0;
int health = 20;
...
void game() {
  arduboy.clear();
  arduboy.print("Game has begun.");
  arduboy.drawBitmap(0, 32, arduman, 24, 28, WHITE);
  arduboy.drawBitmap(100, 32, arduman, 24, 52, WHITE);//makes same sprite as before
  arduboy.display();
